  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <CTABand headline={<>Turn field-tested logic into<br /><span className="text-primary">measurable throughput.</span></>} subcopy="Apply these operational schematics to your environment with a targeted diagnostic." />
      </main>
      <Footer hideCTA />
    </div>
  );
