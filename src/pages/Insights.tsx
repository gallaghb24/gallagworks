  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <CTABand headline={<><span className="whitespace-nowrap">Turn field-tested logic into <span className="text-primary">measurable throughput.</span></span></>} subcopy="Apply these operational schematics to your environment with a targeted diagnostic." />
      </main>
      <Footer hideCTA />
    </div>
  );
