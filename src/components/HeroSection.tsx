...
const HeroSection = () => {
  return (
    <section className="relative z-10 min-h-[60vh] md:min-h-[85vh] flex items-center pt-48 md:pt-24 pb-10 md:pb-16">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight mb-6 md:mb-8 opacity-0 animate-fade-in-up">
              Operational Engineering for<br className="hidden lg:inline" /> the <span className="text-primary">AI Era.</span>
            </h1>

            <p
              className="text-lg md:text-xl text-muted-foreground font-light max-w-[550px] mb-8 md:mb-10 leading-relaxed opacity-0 animate-fade-in-up"
