          ...
          <div className="container mx-auto px-6 lg:px-12 py-28 lg:py-40">
            <div className={`max-w-2xl clip-reveal ${ctaVisible ? "visible" : ""}`}>
              <h2 className="text-2xl md:text-3xl font-extrabold text-foreground mb-4">
                Stop the leakage. Start the Engineering.
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
              ...
              <div>
                ...
                <nav className="flex flex-col gap-3">
                  ...
                  <Link to="/glossary" className="text-sm text-footer-foreground/70 hover:text-primary transition-colors font-mono tracking-widest uppercase">Glossary</Link>
                </nav>
              </div>
            </div>
