...
const StructuredData = () => {
  const professionalService = {
    ...
    founder: {
      ...
      jobTitle: "Principal",
      description:
        "Operational engineering expert with 20+ years directing enterprise delivery for Tier-1 retailers and FTSE 100 entities. Specialises in eradicating manual friction and engineering scalable operational systems.",
      knowsAbout: [
        "Operational Engineering",
        "Enterprise Transformation",
        "Workflow Automation",
  ...
  const personSchema = {
    ...
    description:
      "Operational engineering specialist with 20+ years of enterprise delivery experience managing £15M+ multichannel contracts for Tier-1 retailers and FTSE 100 entities.",
    knowsAbout: [
      "Operational Engineering",
      "Enterprise Transformation",
