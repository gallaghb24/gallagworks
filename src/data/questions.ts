...
export const dimensions: Dimension[] = [
  ...
  },
  {
    ...
    intro: "This dimension assesses whether your current technology can support AI adoption practically. Not whether you have the latest tools, but whether your existing systems can connect, share data, and integrate with AI capabilities without a complete rebuild.",
    questions: [
      {
        id: "ti_1",
  ...
  },
  {
    ...
    intro: "The most overlooked dimension. Most organisations want AI without being able to articulate what problem it solves or how they would know if it worked. This dimension assesses whether your AI ambition is grounded in specific, measurable objectives.",
    questions: [
      {
        id: "stc_1",
        ...
        options: [
          ...
          { value: 2, label: "Vaguely - we have general ideas like 'improve efficiency' but nothing specific" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: 3, label: "We have general KPIs like time saved or cost reduced but nothing baselined" },
          { value: 4, label: "Defined metrics with current baselines for our priority use cases" },
          { value: 5, label: "Structured measurement framework with before and after baselines, control groups, and regular review" },
        ],
      },
      {
        id: "stc_3",
        ...
        options: [
          { value: 1, label: "Nobody - it is not owned" },
          { value: 2, label: "IT is expected to lead it, but without clear mandate or budget" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: 4, label: "Dedicated AI or innovation budget with defined allocation for this year" },
