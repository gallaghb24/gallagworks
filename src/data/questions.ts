...
export const dimensions: Dimension[] = [
  {
    ...
    intro: "This is the Data Glue dimension. Most organisations think they have a data problem when they actually have a data logistics problem — information exists but lives in spreadsheets, email threads, and people's heads.",
    questions: [
      {
        id: "data_foundation_1",
  ...
  },
  {
    ...
    intro: "This is the Operational X-Ray dimension. AI applied to a broken process produces broken outputs faster. The question is whether the organisation has enough process clarity for automation to work.",
    questions: [
      {
      ...
      {
        id: "process_maturity_4",
        text: "How do you handle the \"80/20\" in your workflows — the predictable majority vs the complex exceptions?",
        options: [
          ...
          { value: 4, label: "Clear criteria for routing routine vs complex work, with different handling paths" },
  ...
  },
  {
    ...
    intro: "This dimension assesses whether the organisation has the structures to adopt AI safely — not whether they have a 100-page policy document, but whether they have practical guardrails.",
    questions: [
      {
        id: "governance_risk_1",
      ...
      {
        id: "governance_risk_3",
        text: "How confident are you that sensitive data (client data, financial data, personal data) is not being entered into AI tools by your team?",
        options: [
      ...
      {
        id: "governance_risk_5",
        text: "How prepared are you for AI-related regulatory requirements (e.g. EU AI Act, sector-specific guidance)?",
        options: [
          { value: 1, label: "Not aware of any requirements that apply to us" },
          { value: 2, label: "Aware that regulation is coming but have not assessed the impact" },
          { value: 3, label: "Some awareness with initial assessment of what might apply" },
          { value: 4, label: "Detailed understanding of applicable regulations with a compliance roadmap" },
          { value: 5, label: "Proactive compliance programme with legal review, impact assessments, and regular monitoring of regulatory developments" },
        ],
      },
    ],
  },
  {
    ...
    intro: "The Human Middleware dimension. The hardest part of AI transformation is not the technology — it is getting people to change how they work.",
    questions: [
      {
        id: "skills_culture_1",
        ...
        options: [
          ...
          { value: 2, label: "Scepticism — \"it is just hype\" or \"it will never work for what we do\"" },
      ...
      },
      {
        ...
        options: [
          { value: 1, label: "Almost nobody — AI is seen as something for technical teams" },
          { value: 2, label: "A handful of enthusiasts but it is not widespread" },
          { value: 3, label: "Some teams have a good understanding, others have none" },
          { value: 4, label: "Most team leads understand AI's relevance to their area" },
      ...
      {
        id: "skills_culture_4",
        text: "Do you have people who are already experimenting with AI in their own workflows (even unofficially)?",
        options: [
          { value: 1, label: "Not that we know of (or we have not asked)" },
          ...
          { value: 5, label: "Yes, and we have structured programmes (champions, communities of practice, internal showcases) to scale their learnings" },
        ],
      },
      {
        id: "skills_culture_5",
        ...
        options: [
          ...
          { value: 4, label: "Structured L&D programmes with dedicated time and budget for skill development" },
          { value: 5, label: "Continuous learning culture with dedicated innovation time, learning platforms, mentoring, and career-linked development paths" },
        ],
      },
    ],
  },
